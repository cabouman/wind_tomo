...
num_views = 7
tilt_angle = np.pi/8 # Tilt range of +-45deg
...
# display phantom
plot_image(phantom[display_slice], title='Shepp Logan Phantom', filename='../demo/output/3D_microscopy_phantom.png', vmin=vmin, vmax=vmax)

# display reconstruction
title = f'Slice {display_slice:d} of Reconstruction with NRMSE={nrmse:.3f}.'
plot_image(recon[display_slice], title=title, filename='../demo/output/3D_microscopy_recon.png', vmin=vmin, vmax=vmax)
